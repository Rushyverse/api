package fr.distractic.bukkit.api.item

import fr.distractic.bukkit.api.extension.item
import fr.distractic.bukkit.api.item.exception.CraftResultMissingException
...
public class CraftBuilder {
     ...
     */
    private val craft: Array<ItemStack?> = arrayOfNulls<ItemStack>(9)
