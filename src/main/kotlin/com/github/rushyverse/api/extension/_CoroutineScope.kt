 ...
 * is canceled by the time its dispatcher starts to execute the code,
 ...
 * this call will not be canceled neither on entry to the block inside `withContext` nor on exit from it.
 */
